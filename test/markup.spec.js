...
describe('markup', () => {
	...
	function init(options) {
		editor = new window.Diffinity(`#diffinity-${editorId - 1}`, options);
		return editor;
	};

	beforeEach(() => {
		const div = document.createElement('div');
		div.id = `diffinity-${editorId++}`;
	...
	const LHS_LINE_START = '.diffinity.lhs.d.CodeMirror-linebackground.start';
	const LHS_LINE_END = '.diffinity.lhs.d.CodeMirror-linebackground.end';
	const LHS_LINE_NO_START = '.diffinity.lhs.d.no-start.end.CodeMirror-linebackground';
	const LHS_LINE_NO_END = '.diffinity.lhs.d.CodeMirror-linebackground.start.no-end';
	const LHS_LINE = 'span.diffinity.d.lhs';

	const RHS_LINE_NO_START = '.diffinity.rhs.a.no-start.end.CodeMirror-linebackground';
	const RHS_LINE_NO_END = '.diffinity.rhs.a.CodeMirror-linebackground.start.no-end';
	const RHS_LINE_START = '.diffinity.rhs.a.CodeMirror-linebackground.start';
	const RHS_LINE_END = '.diffinity.rhs.a.CodeMirror-linebackground.end';
	const RHS_LINE_TEXT = 'span.diffinity.a.rhs';

	const LHS_CHANGE_START = '.diffinity.lhs.c.CodeMirror-linebackground.start';
	const LHS_CHANGE_END = '.diffinity.lhs.c.CodeMirror-linebackground.end';
	const LHS_CHANGE_START_AND_END = '.diffinity.lhs.c.CodeMirror-linebackground.start.end';
	const RHS_CHANGE_START = '.diffinity.rhs.c.CodeMirror-linebackground.start';
	const RHS_CHANGE_END = '.diffinity.rhs.c.CodeMirror-linebackground.end';

	const LHS_INLINE_TEXT = '.diffinity.lhs.ind';
	const RHS_INLINE_TEXT = '.diffinity.rhs.ina';
	...
	const opts = [
...

		{
			...
			rhs: '',
			check: (editor) => {
				expect(editor.querySelectorAll('.diffinity.lhs')).to.have.length(0);
				expect(editor.querySelectorAll('.diffinity.rhs')).to.have.length(0);
			}
		},
		{
